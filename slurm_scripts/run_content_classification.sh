#!/bin/bash
#SBATCH --job-name=classify_content
...
#SBATCH --output=logs/classify_content/%x_%A_%a.out
#SBATCH --error=logs/classify_content/%x_%A_%a.err
...
python -m src.keyframes.classify_content
